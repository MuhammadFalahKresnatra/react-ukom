                    ...
                    <div className="card p-2 border-0 shadow mt-5">
                        ...
                        <div className="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <td>Foto Masjid</td>
                                    <td>Donasi Masjid At-Taqwa</td>
                                    <td>Program Pilihan</td>
                                    <td>10.000.000</td>
                                    <td>
                                        <button  className="btn btn-success me-3 btn-sm ">
                                        Disetujui
                                        </button>
                                    </td>
                                    <td>
...
export default Tabelprogramdonasi;
